...
SET @billing_role_id = (SELECT id FROM roles WHERE name = 'billing_staff' LIMIT 1);
...
SET @patient_read = (SELECT id FROM permissions WHERE code = 'patient.read' LIMIT 1);
SET @patient_create = (SELECT id FROM permissions WHERE code = 'patient.create' LIMIT 1);
SET @patient_update = (SELECT id FROM permissions WHERE code = 'patient.update' LIMIT 1);
SET @patient_delete = (SELECT id FROM permissions WHERE code = 'patient.delete' LIMIT 1);
SET @billing_read = (SELECT id FROM permissions WHERE code = 'billing.read' LIMIT 1);
SET @billing_create = (SELECT id FROM permissions WHERE code = 'billing.create' LIMIT 1);
SET @billing_update = (SELECT id FROM permissions WHERE code = 'billing.update' LIMIT 1);
SET @pharmacy_read = (SELECT id FROM permissions WHERE code = 'pharmacy.read' LIMIT 1);
SET @pharmacy_dispense = (SELECT id FROM permissions WHERE code = 'pharmacy.dispense' LIMIT 1);
SET @lab_read = (SELECT id FROM permissions WHERE code = 'lab.read' LIMIT 1);
SET @lab_create = (SELECT id FROM permissions WHERE code = 'lab.create' LIMIT 1);
SET @session_revoke = (SELECT id FROM permissions WHERE code = 'session.revoke' LIMIT 1);
SET @user_read = (SELECT id FROM permissions WHERE code = 'user.read' LIMIT 1);
SET @user_manage = (SELECT id FROM permissions WHERE code = 'user.manage' LIMIT 1);
SET @role_manage = (SELECT id FROM permissions WHERE code = 'role.manage' LIMIT 1);

-- Assign ALL permissions to admin role
INSERT INTO role_permissions (role_id, permission_id, created_at)
SELECT @admin_role_id, p.id, NOW() FROM permissions p
